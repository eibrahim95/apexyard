...
Read `.claude/skills/handover/references/assessment-template.md` and fill in its template. Keep every section of the template.
...
Read `.claude/skills/handover/references/agents-md.md` now and follow it in full. It holds the selection check, the preconditions, the never-overwrite check, the AGENTS.md composition, the branch-and-PR delivery, and the `AGENTS_MD_STATUS` value for the step 10 summary.
...
Read `.claude/skills/handover/references/badge.md` now and follow it in full. It holds the selection check, the preconditions, the variant pick, the idempotency check, the README insert, the branch-and-PR delivery, and the `BADGE_STATUS` value for the step 10 summary.
